      ...
      <main>
        <section className="mx-auto max-w-5xl px-6 py-24 text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-lg text-slate-600">
            Impresiones, venta de insumos y reparación de impresoras con atención
            rápida y precios justos.
          </p>
          <a
            href="#contacto"
        ...
        <section id="nosotros" className="border-t border-slate-200">
          <div className="mx-auto max-w-5xl px-6 py-16">
            ...
            <p className="mt-4 max-w-2xl text-slate-600">
              Somos un local especializado en soluciones de impresión, con años de
              experiencia atendiendo a hogares, estudiantes y oficinas de la zona.
              Nos importa la calidad, la rapidez y un trato cercano con cada cliente.
            </p>
          </div>
        </section>
